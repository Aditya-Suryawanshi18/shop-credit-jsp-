...
public class DBConnection {
    ...
    static {
        try {
            ...
            File configFile = new File(tomcatHome + "/conf/shopcredit_database.conf");
            ...
            throw new RuntimeException("❌ Cannot read shopcredit_database.conf from TOMCAT_HOME/conf/", e);
